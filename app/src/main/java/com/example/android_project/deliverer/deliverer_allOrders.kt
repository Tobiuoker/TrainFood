...
import com.example.android_project.adapters.All_orders_deliverer_adapter
...
import kotlinx.android.synthetic.main.activity_deliverer_all_orders.*

class deliverer_allOrders : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_deliverer_all_orders)
        ...
        bottomNavigationView.selectedItemId = R.id.all_orders
    ...
    private fun recycleView(basket: MutableList<DBOrder>) {
        ...
        all_orders_deliverer_recycleview.layoutManager = layoutManager

        val adapter = All_orders_deliverer_adapter(this, basket)
        all_orders_deliverer_recycleview.adapter = adapter
    }
