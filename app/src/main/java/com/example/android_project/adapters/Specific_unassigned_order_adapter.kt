...
class Specific_unassigned_order_adapter(var context: Context, var order: MutableList<Basket>): RecyclerView.Adapter<Specific_unassigned_order_adapter.ViewHolder>() {
